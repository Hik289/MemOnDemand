...
"""Generate reference answers through the configured general model API."""
...
def gen_one(rec, question_texts, doc_lookup, cost_tracker):
    ...
    for attempt in range(3):
        try:
            resp = api_call('general', messages, max_tokens=400, temperature=0.0, timeout=90.0, max_retries=2)
